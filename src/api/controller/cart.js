...
module.exports = class extends Base {
  ...
  async checkoutBuyNowAction() {
    ...
    if (!think.isEmpty(checkedAddress)) {
      let nowRegion = checkedAddress.region.split(",");
      ...
      checkedAddress.full_region = nowRegion[0] + nowRegion[1] + nowRegion[2];
    }
    ...
    // 计算订单的费用
    const goodsTotalPrice = number * productInfo.retail_price; // 商品总价
    const orderTotalPrice = (number * productInfo.retail_price) + freightPrice - couponPrice; // 订单的总价
